...
{
    public class CardDlyTotal025Configuration : IEntityTypeConfiguration<CardDlyTotal025>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal025> builder)
        {
            builder.ToTable("CARDDLYTOTAL025");
