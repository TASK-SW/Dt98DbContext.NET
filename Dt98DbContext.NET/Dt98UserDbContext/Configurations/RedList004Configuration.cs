...
{
    public class RedList004Configuration : IEntityTypeConfiguration<RedList004>
    {
        public void Configure(EntityTypeBuilder<RedList004> builder)
        {
            builder.ToTable("REDLIST004");
