...
{
    public class CardDlyTotal045Configuration : IEntityTypeConfiguration<CardDlyTotal045>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal045> builder)
        {
            builder.ToTable("CARDDLYTOTAL045");
