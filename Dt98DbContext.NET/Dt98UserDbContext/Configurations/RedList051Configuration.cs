...
{
    public class RedList051Configuration : IEntityTypeConfiguration<RedList051>
    {
        public void Configure(EntityTypeBuilder<RedList051> builder)
        {
            builder.ToTable("REDLIST051");
