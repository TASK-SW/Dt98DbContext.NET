...
{
    public class CardDlyTotal050Configuration : IEntityTypeConfiguration<CardDlyTotal050>
    {
        #region Public Methods

        public void Configure(EntityTypeBuilder<CardDlyTotal050> builder)
        {
            builder.ToTable("CARDDLYTOTAL050");
