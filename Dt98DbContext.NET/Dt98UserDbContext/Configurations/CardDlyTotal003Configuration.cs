...
{
    public class CardDlyTotal003Configuration : IEntityTypeConfiguration<CardDlyTotal003>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal003> builder)
        {
            builder.ToTable("CARDDLYTOTAL003");
