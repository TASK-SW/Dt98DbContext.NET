...
{
    public class CardDlyTotal051Configuration : IEntityTypeConfiguration<CardDlyTotal051>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal051> builder)
        {
            builder.ToTable("CARDDLYTOTAL051");
