...
{
    public class CardDlyTotal029Configuration : IEntityTypeConfiguration<CardDlyTotal029>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal029> builder)
        {
            builder.ToTable("CARDDLYTOTAL029");
