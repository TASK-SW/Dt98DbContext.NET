...
{
    public class CardDlyTotal023Configuration : IEntityTypeConfiguration<CardDlyTotal023>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal023> builder)
        {
            builder.ToTable("CARDDLYTOTAL023");
