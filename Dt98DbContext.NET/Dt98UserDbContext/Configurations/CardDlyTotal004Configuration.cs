...
{
    public class CardDlyTotal004Configuration : IEntityTypeConfiguration<CardDlyTotal004>
    {
        #region Public Methods

        public void Configure(EntityTypeBuilder<CardDlyTotal004> builder)
        {
            builder.ToTable("CARDDLYTOTAL004");
