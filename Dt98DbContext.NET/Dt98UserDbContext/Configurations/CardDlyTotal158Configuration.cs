...
{
    public class CardDlyTotal158Configuration : IEntityTypeConfiguration<CardDlyTotal158>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal158> builder)
        {
            builder.ToTable("CARDDLYTOTAL158");
