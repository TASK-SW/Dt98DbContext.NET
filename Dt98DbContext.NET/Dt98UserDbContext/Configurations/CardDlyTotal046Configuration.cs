...
{
    public class CardDlyTotal046Configuration : IEntityTypeConfiguration<CardDlyTotal046>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal046> builder)
        {
            builder.ToTable("CARDDLYTOTAL046");
