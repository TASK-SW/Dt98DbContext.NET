...
{
    public class CardDlyTotal171Configuration : IEntityTypeConfiguration<CardDlyTotal171>
    {
        public void Configure(EntityTypeBuilder<CardDlyTotal171> builder)
        {
            builder.ToTable("CARDDLYTOTAL171");
