...
{
    public class RedList023Configuration : IEntityTypeConfiguration<RedList023>
    {
        #region Public Methods

        public void Configure(EntityTypeBuilder<RedList023> builder)
        {
            builder.ToTable("REDLIST023");
